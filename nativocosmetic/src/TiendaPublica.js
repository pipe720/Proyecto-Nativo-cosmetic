...
function TiendaPublica() {
  ...
  const { usuarioLogeado, setUsuarioLogeado } = useContext(MiContexto);
...
{usuarioLogeado ? (
  <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
    {/* Muestra el nombre del usuario. Ajusta '.nombre' según cómo guardes el campo en MongoDB */}
    <span className="user-display" style={{ fontWeight: "500", fontSize: "0.95rem" }}>
    ...
    <button
      ...
      onClick={() => setUsuarioLogeado(null)}
    >
      <LogOut />
    </button>
  </div>
  ...
  <button
    className="button secondary compact" /* Cambiado de 'icon-button' a un estilo de botón con texto */
